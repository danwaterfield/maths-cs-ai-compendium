...
- For example, with $A = \begin{bmatrix} 3 & 1 \\ 0 & 2 \end{bmatrix}$: the vector $\begin{bmatrix} 1 \\ 0 \end{bmatrix}$ is an eigenvector with $\lambda = 3$ because $A\begin{bmatrix} 1 \\ 0 \end{bmatrix} = \begin{bmatrix} 3 \\ 0 \end{bmatrix} = 3\begin{bmatrix} 1 \\ 0 \end{bmatrix}$.
